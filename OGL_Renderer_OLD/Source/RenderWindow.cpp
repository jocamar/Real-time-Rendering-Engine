...
void RenderWindow::update(SceneManager& scene, float millis)
{
	...
	{
		//This is completely cobbled together code for showing off the different exposure levels and their effects with HDR
		//@TODO probably should delete this and find a better way to animate exposure
...
{
	//Render all viewports and swap the buffer at the end
